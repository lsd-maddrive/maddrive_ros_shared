...
namespace gazebo
{
    ...
    void TigraPlugin::Load(physics::ModelPtr model, sdf::ElementPtr sdf)
    {
        ...
        {
            ROS_FATAL_STREAM_NAMED(PLUGIN_NAME, "A ROS node for Gazebo has not been initialized, unable to load plugin. "
        ...
        if (sdf->HasElement("trackWidth"))
            ...
            ROS_FATAL_STREAM_NAMED(PLUGIN_NAME, "Parameter 'trackWidth not set - exit'")
        }
